...
# ---------------------------------------------------------------------------
# Sri AI Deployment Tracker
# ---------------------------------------------------------------------------
class PendingDeployment(models.Model):
    """
    Tracks pending autonomous deployments generated by Sri AI (PAB or Reactive).
    """
    STATUS_CHOICES = [
    ...
    def __str__(self):
        return f"Deployment {self.pr_number} - {self.status.upper()}"
